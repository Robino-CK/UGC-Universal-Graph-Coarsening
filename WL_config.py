...
NUM_LABELS = {'cora':1433, 'physics':8415,  'pubmed':500, 'citeseer':3703, 'dblp':1639, 'cs':6805}
NUM_CLASSES = {'cora':7, 'physics':5,  'pubmed':3, 'citeseer':6, 'dblp':4, 'cs':15}
LEARNING_RATES = {'cora':0.003, 'physics':0.003,  'pubmed':0.003, 'citeseer':0.003, 'dblp':0.003, 'cs':0.003}
DECAY_RATES = {'cora':0.0005, 'physics':0.0005,  'pubmed':0.0005, 'citeseer':0.0005, 'dblp':0.0005, 'cs':0.0005}
CHOSEN_EPOCH = {'cora':10,'physics':10,  'pubmed':10, 'citeseer':10, 'dblp':10, 'cs':10,}
