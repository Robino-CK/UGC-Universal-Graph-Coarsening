...
class BaseModel(nn.Module):
    def __init__(self, config):
        ...
        # print("original_features_num ",original_features_num)
        # self.reg_blocks = nn.ModuleList()
        # for layer, next_layer_features in enumerate(block_features):
        #     print("next_layer_features ",next_layer_features)
        ...
        if use_new_suffix:
            ...
            self.fc_layers.append(modules.FullyConnected(original_features_num, 32))
            self.fc_layers.append(modules.FullyConnected(32, 16))
            self.fc_layers.append(modules.FullyConnected(16, self.config.num_classes, activation_fn=None))
